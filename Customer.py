...
class Customer(User):
    ...
    def set_delete_request(self, delete_request):
    ...
    def get_cust_data(self):
        cust_dict = {
            ...
            "has_request": self.__unlock_request or self.__delete_request,
