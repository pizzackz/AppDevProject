...
class User:
    ...
    def __init__(self, user_id, first_name, last_name, username, email, password):
        ...
        self.__joined_date = datetime.now().replace(microsecond=0)
        self.__last_online = self.__joined_date
    ...
    def get_joined_date(self):
        return self.__joined_date.strftime("%d/%m/%Y")

    def get_last_online(self):
        return self.__last_online.strftime("%d/%m/%Y")
